...
urlpatterns = [
    ...
    path("api/internal/salary-payments/readiness/", payment_api.salary_payment_readiness_api, name="salary-payment-readiness-api"),
    ...
    path("api/internal/salary-payments/batches/<uuid:batch_id>/rows/", payment_api.salary_payment_batch_rows_api, name="salary-payment-batch-rows-api"),
    ...
    path("api/internal/lookups/organization/", api.organization_lookup_api, name="organization-lookup-api"),
    path("api/internal/lookups/employees/", api.employee_lookup_api, name="employee-lookup-api"),
    ...
    path("api/internal/employees/summary/", api.employee_summary_api, name="employee-summary-api"),
