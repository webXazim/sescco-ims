        ...
        _bulk_create(
            ...
            (
                SourcingVendor(
                    ...
                    company_phone=f"+96613{i:07d}"[-13:],
                    company_email=f"info-vendor{i:05d}@sdemo.invalid",
                    mobile=f"+96655{i:07d}"[-13:],
                    email=f"vendor{i:05d}@sdemo.invalid",
                    address=f"SDEMO Vendor Address {i:05d}",
                    street_number=str((i % 9999) + 1),
                    district=("Al Faisaliyah", "Al Fanateer", "Al Olaya", "Al Rawdah")[i % 4],
                    city=("Dammam", "Jubail", "Riyadh", "Jeddah")[i % 4],
                    region=("Eastern Province", "Eastern Province", "Riyadh", "Makkah")[i % 4],
                    postal_code=f"{31000 + (i % 8999):05d}",
                    cr_number=f"SDEMO-CR-{i:08d}",
                    vat_number=f"SDEMO-VAT-{i:08d}",
                    website=f"https://vendor{i:05d}.sdemo.invalid",
