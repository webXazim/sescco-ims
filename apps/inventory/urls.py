...
urlpatterns = [
    ...
    path("locations/", InventoryLocationListView.as_view(), name="locations"),
    path("locations/<int:pk>/status/", InventoryLocationStatusView.as_view(), name="location_status"),
    path("locations/<int:pk>/delete/", InventoryLocationDeleteView.as_view(), name="location_delete"),
    path("inventory/", StockItemListView.as_view(), name="list"),
    path("office/", OfficeInventoryView.as_view(), name="office"),
    path("transfers/", StockTransferListView.as_view(), name="transfer_list"),
    path("transfers/new/", StockTransferCreateView.as_view(), name="transfer_create"),
    path(
        "transfers/<uuid:reference>/",
        StockTransferDetailView.as_view(),
        name="transfer_detail",
    ),
    path(
        "transfers/<uuid:reference>/attachment/",
        StockTransferAttachmentView.as_view(),
        name="transfer_attachment",
    ),
    path(
        "transfers/<uuid:reference>/reverse/",
        StockTransferReversalView.as_view(),
