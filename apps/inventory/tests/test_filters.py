...
class AdvancedExplorerTests(TestCase):
    def setUp(self):
        ...
        self.aramco = Project.objects.create(company=self.company, code="ARAMCO-01", name="Aramco Construction")
        self.neom = Project.objects.create(company=self.company, code="NEOM-04", name="NEOM Site Works")
