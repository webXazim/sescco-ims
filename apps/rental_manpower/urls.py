...
urlpatterns = [
    ...
    path("api/rental/supplier-payments/settlement-lookup/", api.supplier_payment_settlement_lookup_api, name="supplier-payment-settlement-lookup-api"),
    ...
    path("api/rental/assignments/project-lookup/", api.assignment_project_lookup_api, name="assignment-project-lookup-api"),
    path("api/rental/suppliers/lookup/", api.supplier_lookup_api, name="supplier-lookup-api"),
