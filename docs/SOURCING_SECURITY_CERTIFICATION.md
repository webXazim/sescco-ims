...
A 1.0.117 deployment is not certified until the full Django runtime suite and this focused certification suite pass against the release image/database during rehearsal. Static verification alone is not runtime evidence.
