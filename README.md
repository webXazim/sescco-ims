...
Current packaged release: **SESCCO MS 1.0.45 — working lifecycle Actions, PostgreSQL-safe recoverable parent cascades, complete Payroll E2E seed verification, and chronology-safe supplier payment seeding**.
