...
for needle in (
    ...
    "key:'salary-structure-employee', endpoint:'/api/internal/lookups/employees/'",
    "boundedDrawerLookupField({label:'Employee',name:'salary-structure-employee'",
...
print("Verified SESCCO MS 1.0.115 Salary Setup scale cutover: employee-first pagination, server search/coverage and lazy per-employee salary history.")
