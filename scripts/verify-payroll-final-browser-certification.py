...
if contract.get("schema_change") is not False or contract.get("payroll_formula_change") is not False:
    fail("1.0.111 must not introduce schema or payroll-formula changes")
...
print("Verified SESCCO MS 1.0.111 final 2K/5K Payroll browser-certification freeze contract across 24 high-cardinality surfaces.")
