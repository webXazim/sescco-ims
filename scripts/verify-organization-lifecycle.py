...
for rel,text in [
 ...
 ("static/payroll/js/app.js","Delete unused record"),
...
if '0009_organization_master_lifecycle.py' not in manifest: fail('migration not frozen')
print('Branch / Office and Department lifecycle contract verified.')
