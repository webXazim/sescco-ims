...
if text("VERSION").strip() != VERSION: fail("VERSION must be 1.0.117")
...
if contract.get("schema_change") is not False: fail("1.0.117 must not introduce a database migration")
if contract.get("payroll_formula_change") is not False: fail("1.0.117 must not change Payroll formulas")
...
print("PASS: SESCCO MS 1.0.117 cross-module access leak closure verified across search, profiles, Documents, Reports, Management, Archive/Trash and scoped selectors.")
