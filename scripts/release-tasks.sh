...
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-freeze.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-type.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-aggregator.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-worker-sheet.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-supplier-summary.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-print-renderer.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-worker-export.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-type-first-generator-api.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-new-documents-ux.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-documents-workspace.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-financial-reconciliation.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-supplier-delivery-cutover.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-scale-production-certification.py"
python3 "${PROJECT_ROOT}/scripts/verify-payroll-document-v3-production-freeze.py"
