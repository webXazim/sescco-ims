...
if contract.get("release") != VERSION or contract.get("schema_change") is not True:
    fail("1.0.113 contract must declare the user-management schema release")
...
print("Verified SESCCO MS 1.0.113 User Management backend: company-scoped CRUD, owner/self protection, password-reset state, atomic scopes, bounded APIs and immutable access audit.")
