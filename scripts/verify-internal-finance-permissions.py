...
if contract.get("predecessor", {}).get("archive_sha256") != PREDECESSOR_SHA: fail("1.0.114 predecessor checksum changed")
if contract.get("schema_change") is not True: fail("1.0.114 must declare its permission/review-signoff schema change")
...
print("PASS: SESCCO MS 1.0.114 Internal Payroll + Finance permission decomposition verified.")
