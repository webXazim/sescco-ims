...
if contract.get("release") != "1.0.111":
    fail("assignment-project selector contract release must be 1.0.111")
...
print("Verified SESCCO MS 1.0.111 assignment project selector scale safety: embedded search, bounded count-free paging, date-valid active projects, current-project exclusion and no directory-cache save dependency.")
