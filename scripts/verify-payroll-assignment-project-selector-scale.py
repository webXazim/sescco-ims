...
if contract.get("release") != "1.0.115":
    fail("assignment-project selector contract release must be 1.0.115")
...
print("Verified SESCCO MS 1.0.115 assignment project selector scale safety: embedded search, bounded count-free paging, date-valid active projects, current-project exclusion and no directory-cache save dependency.")
