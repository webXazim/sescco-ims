...
if contract.get("release") != "1.0.116":
    fail("assignment-project selector contract release must be 1.0.116")
...
print("Verified SESCCO MS 1.0.116 assignment project selector scale safety: embedded search, bounded count-free paging, date-valid active projects, current-project exclusion and no directory-cache save dependency.")
