...
if contract.get("schema_change") is not False:
    fail("1.0.112 must remain schema-neutral")
...
for marker in ("Access History", 'id="history"', 'id="accessHistoryRows"', "?v=1.0.112"):
...
if "1.0.112" not in text("docs/ACCESS_HISTORY_RECOVERY.md"):
    fail("operator guide is not version-bound")

print("PASS: SESCCO MS 1.0.112 immutable Access History and guarded prior-access recovery are release-bound.")
