...
for marker in ("Access History", 'id="history"', 'id="accessHistoryRows"', "?v=1.0.111"):
...
if "1.0.111" not in text("docs/ACCESS_HISTORY_RECOVERY.md"):
    fail("operator guide is not version-bound")

print("PASS: SESCCO MS 1.0.111 immutable Access History and guarded prior-access recovery are release-bound.")
