...
if "1.0.115" not in text("docs/SOURCING_VENDOR_VERIFICATION.md"):
    fail("Vendor verification operator guide is not version-bound")

print(
    "PASS: SESCCO MS 1.0.115 Vendor Verification & History UX verified: manage-only quick confirmation, view-only immutable history, before/after revision evidence, bounded history pagination, Material Finder freshness renewal and zero Inventory/Payroll/Accounting integration."
)
