...
allowed_modes = {
    ...
    "reference_master_archive_hard_delete_legacy_trash",
    "reference_master_inactive_hard_delete",
    "reference_offer_inactive_hard_delete",
    "reference_contact_inactive_hard_delete",
