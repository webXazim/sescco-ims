...
if contract.get("schema_change") is not False or contract.get("payroll_formula_change") is not False:
    fail("1.0.78 report hotfix must not change schema or Payroll formulas")
...
print("Verified SESCCO MS 1.0.78 report/WPS performance hotfix: projection-only WPS rows, in-place report refresh and explicit WPS scale certification.")
