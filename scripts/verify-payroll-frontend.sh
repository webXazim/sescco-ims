...
assert "?v=1.0.43" in text, "Payroll control asset must carry the 1.0.43 cache buster"
assert "payroll/js/app.js' %}?v=1.0.43" in text, "Payroll JS asset must carry the 1.0.43 cache buster"
PY_ORDER
