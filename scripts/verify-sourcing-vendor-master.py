...
if "1.0.116" not in text("docs/SOURCING_VENDOR_MASTER.md"):
    fail("Vendor master operator guide is not version-bound")

print("PASS: SESCCO MS 1.0.116 Vendor Sourcing Master verified: company-scoped server directory, view/edit enforcement, contacts, reversible lifecycle, immutable audit evidence and operational isolation.")
