...
if "1.0.114" not in text("docs/SOURCING_MANPOWER_MASTER.md"):
    fail("Manpower master operator guide is not version-bound")

print("PASS: SESCCO MS 1.0.114 Manpower Sourcing Master verified: company-scoped server directory, view/edit enforcement, contacts, reversible lifecycle, immutable audit evidence and Rental Payroll isolation.")
