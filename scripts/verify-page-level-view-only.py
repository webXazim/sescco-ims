...
if contract.get("release") != VERSION: fail("contract release must be 1.0.117")
if contract.get("schema_change") is not False: fail("1.0.117 must not introduce a schema migration")
...
if "1.0.117" not in text("docs/PAGE_LEVEL_VIEW_ONLY.md"): fail("operator/security documentation missing")
print("PASS: SESCCO MS 1.0.117 page-level View Only and custom Access Profile contract verified.")
