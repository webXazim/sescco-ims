...
if contract.get("schema_change") is not True:
    fail("1.0.112 must declare the Accounts permission-constraint schema change")
...
if "1.0.112" not in text("docs/SOURCING_ACCESS_CONTROL.md"):
    fail("Sourcing access-control guide is not version-bound")

print("PASS: SESCCO MS 1.0.112 Sourcing Access-Control Authority verified: Vendor/Manpower/Master view-edit separation, owner-only builtin grant, permission-aware module visibility and backend enforcement.")
