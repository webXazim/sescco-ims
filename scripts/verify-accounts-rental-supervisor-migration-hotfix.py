...
if "1.0.117" not in read("docs/ACCOUNTS_RENTAL_SUPERVISOR_MIGRATION_HOTFIX.md"):
    fail("historical hotfix guide is not carried forward to 1.0.117")
...
print("Verified SESCCO MS 1.0.117 Accounts Rental Supervisor historical migration hotfix: core.Company lookup, database-alias-safe RunPython, no new schema migration, and no remaining accounts.Company migration lookup.")
