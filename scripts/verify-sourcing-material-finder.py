...
if "1.0.117" not in text("docs/SOURCING_MATERIAL_FINDER.md"):
    fail("Material Finder operator guide is not version-bound")

print(
    "PASS: SESCCO MS 1.0.117 Material Finder verified: company-scoped Vendor offer search, controlled aliases, freshness policy, bounded server pagination, Vendor view/edit separation and zero operational Inventory/Payroll/Accounting integration."
)
