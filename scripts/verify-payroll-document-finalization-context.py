...
if contract.get("release") != "1.0.87":
    fail("document finalization context contract release must be 1.0.87")
...
print("Verified SESCCO MS 1.0.87 contextual Payroll document finalization: employee-locked Salary Slip sources and type-only Supplier Invoice fields.")
