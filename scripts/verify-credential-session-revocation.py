...
if "1.0.111" not in text("docs/CREDENTIAL_SESSION_REVOCATION.md"):
    fail("operator guide is not version-bound")

print("PASS: SESCCO MS 1.0.111 credential/session revocation and mandatory temporary-password change are release-bound.")
