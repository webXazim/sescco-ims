...
if contract.get("release") != "1.0.117":
    fail("certification contract release must be 1.0.117")
...
required_labels = {
    ...
    "apps.documents.tests.test_v3_contract_freeze",
    "apps.documents.tests.test_v3_type_foundation",
    "apps.documents.tests.test_v3_supplier_timesheet_pack_aggregator",
    "apps.documents.tests.test_v3_worker_monthly_sheet_contract",
    "apps.documents.tests.test_v3_supplier_summary_contract",
    "apps.documents.tests.test_v3_production_print_renderer",
    "apps.documents.tests.test_v3_type_first_generator_api",
    "apps.documents.tests.test_v3_new_documents_ux_cutover",
    "apps.documents.tests.test_v3_documents_workspace_cleanup",
    "apps.documents.tests.test_v3_financial_document_reconciliation",
    "apps.documents.tests.test_v3_supplier_delivery_cutover",
    "apps.documents.tests.test_v3_scale_production_certification",
    "apps.documents.tests.test_v3_production_freeze_acceptance",
...
required_verifiers = {
    ...
    "scripts/verify-payroll-document-v3-type.py",
    "scripts/verify-payroll-document-v3-aggregator.py",
    "scripts/verify-payroll-document-v3-worker-sheet.py",
    "scripts/verify-payroll-document-v3-supplier-summary.py",
    "scripts/verify-payroll-document-v3-print-renderer.py",
    "scripts/verify-payroll-document-v3-worker-export.py",
    "scripts/verify-payroll-document-v3-type-first-generator-api.py",
    "scripts/verify-payroll-document-v3-new-documents-ux.py",
    "scripts/verify-payroll-document-v3-documents-workspace.py",
    "scripts/verify-payroll-document-v3-financial-reconciliation.py",
    "scripts/verify-payroll-document-v3-supplier-delivery-cutover.py",
    "scripts/verify-payroll-document-v3-scale-production-certification.py",
    "scripts/verify-payroll-document-v3-production-freeze.py",
...
required_scenarios = {
    ...
    "rental-document-v3-contract-freeze",
    "supplier-timesheet-pack-v3-type-foundation",
    "supplier-timesheet-pack-v3-snapshot-aggregator",
    "supplier-timesheet-pack-v3-worker-monthly-sheet-contract",
    "supplier-timesheet-pack-v3-supplier-summary-contract",
    "supplier-timesheet-pack-v3-production-print-renderer",
    "supplier-timesheet-pack-v3-derived-worker-timesheet-export",
    "supplier-timesheet-pack-v3-type-first-generator-api",
    "supplier-timesheet-pack-v3-new-documents-ux-cutover",
    "supplier-timesheet-pack-v3-documents-workspace-cleanup",
    "supplier-timesheet-pack-v3-financial-document-reconciliation",
    "supplier-timesheet-pack-v3-supplier-delivery-cutover",
