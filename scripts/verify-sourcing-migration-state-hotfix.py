...
print("Verified SESCCO MS 1.0.115 Sourcing migration-state drift hotfix: 11 company relations + 2 deleted_by relations aligned without data/column/index changes.")
